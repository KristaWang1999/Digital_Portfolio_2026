      ...
      >
        ...
        <div className="absolute inset-0 rounded-[2.5rem] overflow-hidden border border-white/10 bg-[#0A0A0A] shadow-2xl flex flex-col transform-gpu">
          ...
          <div className="relative z-20 flex-grow px-8 pb-10 flex flex-col justify-end">
            <div className="mb-2">
              <h3 className="text-3xl font-bold text-white tracking-tight leading-tight transition-transform duration-500 group-hover:translate-x-1 whitespace-nowrap overflow-hidden text-ellipsis">
                {project.title}
              </h3>
            </div>
            ...
            {/* Brief Description - Standardized to 16px (text-base) */}
            <p className="text-base text-gray-400 leading-relaxed font-medium line-clamp-2 group-hover:text-white transition-colors duration-500 max-w-[95%]">
              {project.description}
            </p>
          </div>
